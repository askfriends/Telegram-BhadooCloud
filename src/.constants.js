module.exports = Object.freeze({
  TOKEN: '1342038212:AAFRPtoVJdbSrCEaSf_V29SZfACAws2m_LA', //required
  ARIA_SECRET: '#ajank786', //change as per needs.
  ARIA_DOWNLOAD_LOCATION: '/app/downloads)', //-leave as it is
  INDEX_DOMAIN: 'https://go.askfriends.workers.dev/', // replace with your index domain. use https://github.com/ParveenBhadooOfficial/go-drive
  ...
  GDRIVE_PARENT_DIR_ID:  '1O4t6lXOVbDOFrlRPBM9V1QIdYWExq10l', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  SUDO_USERS: [1271425814],	// Telegram user IDs. These users can use the bot in any chat. required, get it using https://t.me/YourTGid_Bot
  AUTHORIZED_CHATS: [-1001142105709],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
